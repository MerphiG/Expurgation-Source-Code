	...
	override function beatHit()
	{
		...
		if(!closedState) {
			switch (curBeat)
			{
				...
				case 3:
					addMoreText('Merphi, HopKa', 45);
					addMoreText('HRistofor4ik', 45);
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['I so tired'], -60);
				case 7:
					addMoreText('So laggy mod', -60);
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('EXPURGATION'); // credTextShit.text += '\nFunkin';
